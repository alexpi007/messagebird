...
It is a SPA to send and receive SMS via [MessageBird](https://www.messagebird.com/) API.
In order to use it you should sign up to MessageBird service. Afterwards, you should add your MessageBird API Key (test or live) within `public/config.json`, that's it!
